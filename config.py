...
class Config:
    ...
    AUTH0_CALLBACK_URL  = os.environ.get("AUTH0_CALLBACK_URL",  "https://combine-authentication.vercel.app/callback")
    APP_BASE_URL        = os.environ.get("APP_BASE_URL",        "https://combine-authentication.vercel.app")
